    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3"
                    src="{{ asset('frontend-assets/img/category/icon1.png') }}" width="75" alt="Feature" />
                <h4 class="mb-3">First click tests</h4>
                <p class="mb-0 fw-medium text-secondary">While most people enjoy casino gambling,</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3"
                    src="{{ asset('frontend-assets/img/category/icon2.png') }}" width="75" alt="Feature" />
            ...
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3"
                    src="{{ asset('frontend-assets/img/category/icon3.png') }}" width="75" alt="Feature" />
                <h4 class="mb-3">Preference tests</h4>
                <p class="mb-0 fw-medium text-secondary">The Myspace page defines the individual.</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3"
                    src="{{ asset('frontend-assets/img/category/icon4.png') }}" width="75" alt="Feature" />
...
<section class="pt-5" id="manager">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('frontend-assets/img/manager/manager.png') }}"
                    alt="" /></div>
            <div class="col-lg-6">
                ...
                <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2"
                        src="{{ asset('frontend-assets/img/manager/tick.png') }}" width="35" alt="tick" />
...
<section class="pt-5" id="marketer">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="{{ asset('frontend-assets/img/marketer/marketer.png') }}"
                    alt="" /></div>
        </div>
    </div><!-- end of .container-->
