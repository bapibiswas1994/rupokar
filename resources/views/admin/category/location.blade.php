            ...
            <div class="col-md-12">
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <form action="{{ url('admin/save-location') }}" method="POST">
                            @csrf
                            <div class="row">

                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label class="text-12">Location</label>
                                        <input type="text" name="location_name" class="form-control  @error('location_name') is-invalid @enderror" placeholder="Location">
                                        <span class="text-danger" style="font-size: 12px">{{ $errors->first('location_name') }}</span>  
                                    </div>
                                </div>
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                        <div class="table-responsive action-table">
                            <table id="table-recom example" width="100%" border="0" cellspacing="0" cellpadding="0"
