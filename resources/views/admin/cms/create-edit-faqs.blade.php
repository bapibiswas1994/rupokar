    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-subheader__main">
            ...
            <div class="kt-subheader__breadcrumbs">
                ...
                <span class="kt-subheader__breadcrumbs-separator"></span>
                <a href=" {{ $faqs ? route('admin.faqs.edit') : route('admin.faqs.create') }}"
                    class="kt-subheader__breadcrumbs-link kt-subheader__breadcrumbs-link--active">{{ $faqs ? 'Edit' : 'Add' }} FAQ's</a>
            </div>
        </div>
        {{-- <div class="kt-subheader__toolbar">
            <div class="kt-subheader__wrapper">
                <a href="{{ route('admin.faqs.create') }}" class="btn kt-subheader__btn-daterange" id=""
                    data-toggle="kt-tooltip" title="Click to add new category" data-placement="left">
					<i class="fa fa-plus-square" aria-hidden="true"></i>Add New FAQ's
				</a>
