...
<div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
            ...
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--open kt-menu__item--here kt-menu__item--submenu kt-menu__item--rel kt-menu__item--open kt-menu__item--here kt-menu__item--active"
                    data-ktmenu-submenu-toggle="click" aria-haspopup="true"><a href="javascript:;"
                        class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-text">Quick Pages</span></a>
                        ...
                        <ul class="kt-menu__subnav">
                            ...
                            <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover"
                                aria-haspopup="true"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
                                        ...
                                        Manager</span><i class="kt-menu__hor-arrow la la-angle-right"></i></a>
    ...
    <div class="kt-header__topbar">
        ...
        {{-- <div class="kt-header__topbar-item kt-header__topbar-item--langs">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
                <span class="kt-header__topbar-icon">
                    <img class="" src="{{ asset('admin-assets/media/flags/020-flag.svg') }}" alt="" />
                </span>
            </div>
            <div
                ...
                <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                    <li class="kt-nav__item kt-nav__item--active">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img
                                    src="{{ asset('admin-assets/media/flags/020-flag.svg') }}" alt="" /></span>
                    ...
                    <li class="kt-nav__item">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img
                                    src="{{ asset('admin-assets/media/flags/016-spain.svg') }}" alt="" /></span>
                    ...
                    <li class="kt-nav__item">
                        <a href="#" class="kt-nav__link">
                            <span class="kt-nav__link-icon"><img
                                    src="{{ asset('admin-assets/media/flags/017-germany.svg') }}" alt="" /></span>
